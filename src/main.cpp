...
int main() {
    ...
    //unsigned long input_as_long[101];
    //fill_ul_array_from_char_array("MKUHXPTBDNRAXAJVKMXAGUBAXCYKIWCTKWMRVHCEVEZMGGPXGVXXOXIENUCLIKEXZTUXIZGWOFGMQFAWHHXHPAXIASJDOURDTEZK", input_as_long, 100);
    //int comp = compare_substrings(input_as_long, 67, 86, 100, true);
    ...
    testOptimalSuffixArray("MKUHXPTBDNRAXAJVKMXAGUBAXCYKIWCTKWMRVHCEVEZMGGPXGVXXOXIENUCLIKEXZTUXIZGWOFGMQFAWHHXHPAXIASJDOURDTEZK", 100);
